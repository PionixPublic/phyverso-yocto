...
You can manually change those files on the target system after building/installing a bundle with the default values or you can set the following variables in `local.conf` to your needs:
